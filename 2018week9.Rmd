...
# Remember that this should be a straight line - you don't want to see a patern in the residuals
...
In top row, Prestige is the Y variable. 
...
# If you set type = "html", you will only be able to see it when you knit
